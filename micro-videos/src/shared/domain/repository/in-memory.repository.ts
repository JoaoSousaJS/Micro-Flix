...
import {
  RepositoryInterface, SearchableRepositoryInterface, SearchParams, SearchResult, SortDirection,
...
export abstract class InMemorySearchableRepository<E extends Entity> extends InMemoryRepository<E>
  implements SearchableRepositoryInterface<E> {
    ...
    async search(props: SearchParams): Promise<SearchResult<E>> {
      ...
      const paginatedItems = await this.applyPaginate(sortedItems, props.page, props.per_page);
